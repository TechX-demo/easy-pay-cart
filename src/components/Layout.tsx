      ...
      <footer className="bg-muted/30 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">EasyShop</h3>
              <p className="text-muted-foreground mb-4">
                Simplifying your shopping experience with elegance and innovation.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/products" className="text-muted-foreground hover:text-foreground transition-colors">Featured Items</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/about" className="text-muted-foreground hover:text-foreground transition-colors">Careers</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/" className="text-muted-foreground hover:text-foreground transition-colors">Shipping Policy</Link></li>
              </ul>
            </div>
          </div>
